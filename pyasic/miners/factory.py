...
from pyasic.miners.antminer.bmminer.X21.S21 import (
    BMMinerS21EHydro,
    BMMinerS21EXPHydro,
    BMMinerS21XPHydro,
)
...
MINER_CLASSES = {
    MinerTypes.ANTMINER: {
        ...
        "ANTMINER S21E XP HYD.": BMMinerS21EXPHydro,
    ...
    MinerTypes.HASHMASTER: {
        ...
        "ANTMINER S21E XP HYD (HASHMASTER)": HashMasterS21EXPHydro,
        "ANTMINER S21 XP (HASHMASTER)": HashMasterS21XP,
        "ANTMINER S21+ HYD (HASHMASTER)": HashMasterS21PlusHydro,
        "ANTMINER T21 (HASHMASTER)": HashMasterT21,
        "ANTMINER S19 XP (HASHMASTER)": HashMasterS19XP,
